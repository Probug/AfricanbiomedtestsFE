...
const ResetPassword = () => {
    ...
    function getForm() {
        ...
        function onSubmit(fields, props) {
            //toast.clear();
            accountService.resetPassword(token, fields)
                .then(() => {
    ...
    function getBody() {
        switch (tokenStatus) {
            ...
            case TokenStatus.Invalid:
                return <div>Token validation failed, if the token has expired you can get a new one at the <Link component={RouterLink} to="/accounts/forgotpassword">forgot password</Link> page.</div>;

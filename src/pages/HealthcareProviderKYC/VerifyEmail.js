...
const VerifyEmail = () => {
    ...
    useEffect(() => {
        ...
        serviceOutletService.verifyEmail(token)
            .then(() => {
    ...
    function getBody() {
        ...
        switch (emailStatus) {
            ...
            case EmailStatus.Failed:
                return <div>Verification failed, you can also verify your account using the <Link component={RouterLink} to="/serviceoutletforgotPassword">forgot password</Link> page.</div>;
        }
    }
